...
in the last three months" into one search box.

Sealshot indexes the text in every capture on your Mac, and nowhere else. See
[the Library](/docs/guide/library/) for how that search works today.
