...
The current release. Send Feedback no longer freezes Sealshot, several Settings
switches now show their real state instead of appearing to change on their own,
and the welcome tour has caught up with the rest of the app.

**License files have a new format in this release, and a file issued before it
will not open.** If you are holding one, see Licensing below — write to
support@seal-shot.com and we will reissue it. Your purchase and your update
