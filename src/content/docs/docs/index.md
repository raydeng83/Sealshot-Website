...
Sealshot is a [one-time purchase](/buy/), activated by a license file
that works entirely offline — no account, no activation server. The app
never stops working, and update renewals are
