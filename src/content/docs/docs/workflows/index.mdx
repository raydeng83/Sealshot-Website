...
Text](/docs/guide/ai/#ocr-live-text) lets you select text straight off
the image; [Enhance Clarity and Remove
Background](/docs/guide/ai/#enhance-clarity-and-remove-background)
...
it [expands your query](/docs/guide/ai/#smart-search) to related terms,
...
Look](/docs/guide/library/#preview) without an editor round-trip.
